...
back = pygame.image.load("C:\\Users\\RUSHIKESH\\Desktop\\Final\\Py.jpg")
...
def gameloop():
    ...
    global music
    with open('C:\\Users\\RUSHIKESH\\Desktop\\Final\\hiscore.txt','r') as f:
         hiscore = f.read()

    if music:
        pygame.mixer.music.load('C:\\Users\\RUSHIKESH\\Desktop\\Final\\Back.mp3')
        pygame.mixer.music.play()


    while not exit_game:
        if game_over:
            with open('C:\\Users\\RUSHIKESH\\Desktop\\Final\\hiscore.txt','w') as f:
                f.write(str(hiscore))
